 ...
 * @author PC
 */
@ServerEndpoint(value = "/chat2/{name}", decoders = MessageDecoder.class, encoders = MessageEncoder.class)
public class Chat {
    private Session sesion;
    private static Set<Chat> chatEndPoints= new CopyOnWriteArraySet<>();
    private static HashMap<String, String> users=new HashMap<>();
    
    @OnOpen
    public void onOpen(Session sesion,
            @PathParam("name") String username)throws IOException, EncodeException{
        this.sesion=sesion;
